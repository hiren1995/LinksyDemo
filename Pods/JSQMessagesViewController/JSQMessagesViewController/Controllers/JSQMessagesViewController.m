...
- (void)jsq_configureMessagesViewController
{
    ...
    self.collectionView.frame = CGRectMake( self.collectionView.frame.origin.x, self.collectionView.frame.origin.y+68, self.collectionView.frame.size.width, self.collectionView.frame.size.height - 68);
