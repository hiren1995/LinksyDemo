...
- (void)commonInit {
    ...
    _on = NO;
    _hideBox = NO;
    _onTintColor = [UIColor colorWithRed:0 green:157.0/255.0 blue:217.0/255.0 alpha:1];
    _onFillColor = [UIColor colorWithRed:0 green:157.0/255.0 blue:217.0/255.0 alpha:1];
    _offFillColor = [UIColor clearColor];
    _onCheckColor = [UIColor colorWithRed:255 green:255.0/255.0 blue:255.0/255.0 alpha:1];
